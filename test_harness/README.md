...
- **Permutates Components** — Automatically swaps modules (e.g., swapping Prometheus for OpenTelemetry, or GPT-5 for a local Llama-4 model) within a live pipeline.
- **Injects Deterministic Stress** — Uses chaos engineering to simulate multi-layered outages across edge and cloud nodes.
...
|-------------|------------------------------------------|---------------------------------------|
| Ingestion   | Data collection and normalization        | Fluentd, Vector, OpenTelemetry        |
...
| Action      | Execution of remediation steps           | Ansible, Terraform, K8s Operators     |
...
2. **Integration Strategy** — Support for LF Edge projects (e.g., EdgeX Foundry, Fledge)
3. **Governance Model** — Proposed maintainer structure and open-source contribution plan
4. **PoC (Optional)** — Link to a GitHub repository or video demonstration of the logic
...
| Interoperability | 20%    | Alignment with MCP, OpenTelemetry, and LF Edge projects      |
| Feasibility      | 20%    | Realistic timeline, resource requirements, and project roadmap |

## 6. Important Dates

- **March 10 – March 20, 2026** — Q&A Period
- **May 1, 2026 (5:00 PM PT)** — Submission Deadline
- **May 10 – May 20, 2026** — Shortlist Interviews
- **June 2026** — Winner Announcement (Live at ONE Summit)
...
- **Slack:** #acpbh-rfp-discussion on the LF Edge Workspace
